...
| `GET` | `/sync/shipments?organizationId=&shipmentIds=` | D1 maps for the listed Sutton shipment ids (comma-separated, max 100). Includes `ssLabelId`, `hasLabel`, and `packageSelections` for those shipments. |
